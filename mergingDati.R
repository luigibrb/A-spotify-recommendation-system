...
simo <- read.csv2("artistiSimona1.csv")
...
total[is.na(total)] = 0
artisti <- sort(as.character(m$Var1))
total <- total[, artisti]
utenti = c("Luigi", "Lorenzo","Jacopo", "Francesco", "Gianluca", "Chiara", "Irene", "Andrea", "Daniele", "Dani", "Adriano", "Simona")
rownames(total) = utenti

remove(a, b, c, d, e, f, fra, gia, jac, lor, lui, chi, dani, and, adri, dan, simo, g, h, i, ire, l, m)
View(total)
